...
public class Player {
    ...
    static public enum State {FOLDED,INGAME,ALLIN}; //Values of the player's state
   ...
   public void resetBet(){ 
	...
	/**
	 *
	 * Demand the amount to be raised from the player, and raise
	 */
	public void raise(){
	...
	/**
	 *
	 * Give turn to the player so that he chooses his action
	 */ 
